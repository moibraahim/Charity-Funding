...
Board.prototype.toggleTutorialButtons = function() {
  ...
  function nextPreviousClick() {
    if (counter === 1) {
      document.getElementById("tutorial").innerHTML = `<h3>Welcome to The Search Visualizer!</h3><h6>This short tutorial will walk you through all of the features of this application.</h6><p>This is a searching algorithms visualizer, here you can choose any of the search algorithms and start visualizing it.</p><div id="tutorialCounter">1/9</div><img id="mainTutorialImage" src="public/styling/c_icon.jpg"><button id="nextButton" class="btn btn-default navbar-btn" type="button">Next</button><button id="previousButton" class="btn btn-default navbar-btn" type="button">Previous</button><button id="skipButton" class="btn btn-default navbar-btn" type="button">Skip Tutorial</button>`
    } else if (counter === 2) {
      document.getElementById("tutorial").innerHTML = `<h3>What is a Search algorithm?</h3><h6>At its core, a search algorithm seeks to find the shortest path between two points. This application visualizes various search algorithms in action, and more!</h6><p></p><div id="tutorialCounter">${counter}/9</div><img id="mainTutorialImage" src="public/styling/neural.png"><button id="nextButton" class="btn btn-default navbar-btn" type="button">Next</button><button id="previousButton" class="btn btn-default navbar-btn" type="button">Previous</button><button id="skipButton" class="btn btn-default navbar-btn" type="button">Skip Tutorial</button>`
    } else if (counter === 3) {
      document.getElementById("tutorial").innerHTML = `<h3>Know more about the search agent</h3><h6>Want to know more information about the search agent? click on the Search agent button</h6><p></p><div id="tutorialCounter">${counter}/9</div><img id="secondTutorialImage" src="public/styling/algorithms.png"><button id="nextButton" class="btn btn-default navbar-btn" type="button">Next</button><button id="previousButton" class="btn btn-default navbar-btn" type="button">Previous</button><button id="skipButton" class="btn btn-default navbar-btn" type="button">Skip Tutorial</button>`
    } else if (counter === 4) {
      document.getElementById("tutorial").innerHTML = `<h3>Easy to follow Visualizer</h3><h6>You can easily follow the visualization process by following the colors pattern untill it reaches the goal</h6><p></p><div id="tutorialCounter">${counter}/9</div><img id="secondTutorialImage" src="public/styling/chip.png"><button id="nextButton" class="btn btn-default navbar-btn" type="button">Next</button><button id="previousButton" class="btn btn-default navbar-btn" type="button">Previous</button><button id="skipButton" class="btn btn-default navbar-btn" type="button">Skip Tutorial</button>`
    } else if (counter === 5) {
      document.getElementById("tutorial").innerHTML = `<h3>Choose from various algorithms</h3><h6>You can choose from various algorithms such as the BFS, DFC, Uniform cost, Greedy and A*</h6><p></p><div id="tutorialCounter">${counter}/9</div><img id="secondTutorialImage" src="public/styling/neural-network.png"><button id="nextButton" class="btn btn-default navbar-btn" type="button">Next</button><button id="previousButton" class="btn btn-default navbar-btn" type="button">Previous</button><button id="skipButton" class="btn btn-default navbar-btn" type="button">Skip Tutorial</button>`
    } else if (counter === 6) {
      document.getElementById("tutorial").innerHTML = `<h3>Save What you have done</h3><h6>You can save what you have done by mouse right click, then save image as</h6><p></p><div id="tutorialCounter">${counter}/9</div><img id="secondTutorialImage" src="public/styling/agent.png"><button id="nextButton" class="btn btn-default navbar-btn" type="button">Next</button><button id="previousButton" class="btn btn-default navbar-btn" type="button">Previous</button><button id="skipButton" class="btn btn-default navbar-btn" type="button">Skip Tutorial</button>`
    } else if (counter === 7) {
      document.getElementById("tutorial").innerHTML = `<h3> About the team </h3><h6>know more about the team and how each one implemented his own algorithm</h6><p></p><div id="tutorialCounter">${counter}/9</div><img id="secondTutorialImage" src="public/styling/process.png"><button id="nextButton" class="btn btn-default navbar-btn" type="button">Next</button><button id="previousButton" class="btn btn-default navbar-btn" type="button">Previous</button><button id="skipButton" class="btn btn-default navbar-btn" type="button">Skip Tutorial</button>`
    }else if (counter === 8) {
      document.getElementById("tutorial").innerHTML =  `<h3>Learn more from the documentation</h3><h6>You can view the project documentation and there you find a lot of useful information about the project and how it was implemented</h6><p></p><div id="tutorialCounter">${counter}/9</div><img id="secondTutorialImage" src="public/styling/algorithms.png"><button id="nextButton" class="btn btn-default navbar-btn" type="button">Next</button><button id="previousButton" class="btn btn-default navbar-btn" type="button">Previous</button><button id="skipButton" class="btn btn-default navbar-btn" type="button">Skip Tutorial</button>`
    } else if (counter === 9) {
      document.getElementById("tutorial").innerHTML = `<h3>Enjoy!</h3><h6>We hope you have fun while learning and visualizing the algorithms from the application as much fun </h6><p>If you want to get more information, check out the project documentation page <a href="">documentation page</a>.</p><div id="tutorialCounter">${counter}/9</div><img id="mainTutorialImage" src="public/styling/robot.png"><button id="finishButton" class="btn btn-default navbar-btn" type="button">Finish</button><button id="previousButton" class="btn btn-default navbar-btn" type="button">Previous</button><button id="skipButton" class="btn btn-default navbar-btn" type="button">Skip Tutorial</button>`
