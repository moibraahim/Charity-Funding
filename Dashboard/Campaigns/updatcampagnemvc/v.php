<head>
<meta charset="UTF-8">
<title>UPDATE campagine Form</title>
</head>
<body>

<h1>UPDATE campagine Form</h1>
<form action="c.php" method="post">
    <p>
        <label for="id">campagine id:</label>
        <input type="text" name="id" id="id">
    </p>
    <p>
        <label for="name">campagine Name:</label>
        <input type="text" name="name" id="name">
    </p>
    <p>
        <label for="goal">campagine goal:</label>
        <input type="text" name="goal" id="goal">
    </p>
    <p>
        <label for="code">campagine code:</label>
        <input type="text" name="code" id="code">
    </p>
    <p>
        <label for="description">campagine description:</label>
